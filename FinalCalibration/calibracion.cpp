//g++ calibracion.cpp -o calibracion `pkg-config --cflags --libs opencv`
#include <iostream>
#include <sstream>
#include <string>
#include <ctime>
...
int main(int argc, char* argv[]){
    ...
    for(;;){
        ...
        // ============================================ FRAMES ====================================
        String filename = "Frames_Rings/frame";
        String filename2 = "Frames_Rings_Color/frame";
 ...
 */
    ...
    adaptiveThreshold(gray, binarized, 255, ADAPTIVE_THRESH_GAUSSIAN_C, THRESH_BINARY,15,3); //11

/*
    Morphological Transformations
    -----------------------------
 */
    cv::Mat element = getStructuringElement( MORPH_ELLIPSE, Size ( 7, 7 ),Point( 2, 2 )); //5*5
